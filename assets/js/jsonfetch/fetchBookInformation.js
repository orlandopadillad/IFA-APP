...
function fetchBibliographyPortugues (isbnvalue,  divToOutputOrisasFetchedInformation){
               ...
               if ((element.isbnThirteen == isbnvalue) || (element.isbnTen == isbnvalue)) {
                   ...
                   bibliographyOutput = 
                    `
                       ...
                       <div class="card-body" style="text-align: center;">
                           <a href="${element.url}" target="_blank" class="card-link" style="font-weight: bolder;">Compre o livro</a>
                       </div>
                   `;
